                ...
                <div id="slide1" className="carousel-item relative w-full">
                    ...
                    <div className="absolute flex items-center h-full text-white bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0.00)]">
                        <div className='pl-24  space-y-5 leading-relaxed'>
                            <h3 className="w-3/5 text-5xl font-extrabold leading-tight"><span className="text-orange-400">Reading is a valuable</span>  skill for acquiring <span className="text-orange-400">knowledge</span></h3>
                            <p className='w-2/3'> Libraries are valuable sources of reliable information. They offer reference materials, research assistance, and access to academic journals, helping individuals with academic and professional research.</p>

                            <button className='py-2 px-5 rounded-md font-bold bg-orange-600 text-white  '>Knowledge is Everything</button>
