...
const Login = () => {
    ...
    return (
        <>
            ...
            <div className="px-8 py-3 rounded-md m-10  shadow-lg max-md:w-full max-md:mx-5 w-1/3 mx-auto">
                ...
                <form onSubmit={handleLoginSubmit}>
                    ...
                    <div className="form-control pb-3 ">
                        <input type="submit" value="Sign In" className="cursor-pointer input input-sm text-black bg-[#176B87]" />
                    </div>
